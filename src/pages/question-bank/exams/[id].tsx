...
import ExamDetail from "@/components/question-bank/exams/exam-detail"
  ...
  try {
    ...
    return (
      <div className="container py-8">
        <h1 className="text-3xl font-bold tracking-tight mb-6">Chi Tiết Đề Thi</h1>
        <ExamDetail exam={exam} examQuestions={examQuestions || []} />
      </div>
    )
  } catch (error) {
